...
<desc>Geographic network of Spain including the Balearic Islands and a Canary Islands inset. Copper pairs of directed vectors share an origin and an angle arc.</desc>
...
<g stroke="${vectorColor}" stroke-width="1.15" opacity=".6">${vectors.join('')}</g>
...
const graph = { width: 800, height: 700, nodes, connections, vectors: vectorData };
...
console.log(`Generated ${nodes.length} geographic nodes, ${lines.length} connections and ${vectors.length} vector pairs at ${fileURLToPath(new URL('assets/spain-network.svg', base))}`);
